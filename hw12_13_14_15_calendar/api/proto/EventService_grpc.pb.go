...
const (
	EventService_ListEventsByDay_FullMethodName   = "/EventService/ListEventsByDay"
	EventService_ListEventsByWeek_FullMethodName  = "/EventService/ListEventsByWeek"
	EventService_ListEventsByMonth_FullMethodName = "/EventService/ListEventsByMonth"
...
type EventServiceClient interface {
	...
	CreateEvent(ctx context.Context, in *CreateEventRequest, opts ...grpc.CallOption) (*EditEventResponse, error)
	UpdateEvent(ctx context.Context, in *UpdateEventRequest, opts ...grpc.CallOption) (*EditEventResponse, error)
...
func (c *eventServiceClient) CreateEvent(ctx context.Context, in *CreateEventRequest, opts ...grpc.CallOption) (*EditEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *eventServiceClient) UpdateEvent(ctx context.Context, in *UpdateEventRequest, opts ...grpc.CallOption) (*EditEventResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(EditEventResponse)
...
type EventServiceServer interface {
	...
	CreateEvent(context.Context, *CreateEventRequest) (*EditEventResponse, error)
	UpdateEvent(context.Context, *UpdateEventRequest) (*EditEventResponse, error)
...
func (UnimplementedEventServiceServer) CreateEvent(context.Context, *CreateEventRequest) (*EditEventResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreateEvent not implemented")
}
func (UnimplementedEventServiceServer) UpdateEvent(context.Context, *UpdateEventRequest) (*EditEventResponse, error) {
